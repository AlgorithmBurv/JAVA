...
public class DataBarang extends javax.swing.JFrame {
    ...
    private void autonumber() {
        try {
            ...
            if (r.next()) {
                String no_faktur = r.getString("id_barang").substring(2);
                String BR = "" + (Integer.parseInt(no_faktur) + 1);
                String Nol = "";
    ...
    public DataBarang() {
        ...
        model.addColumn("jenis_barang_barang");
    ...
    private void initComponents() {
        ...
        cbjenis_barang_barang = new javax.swing.JComboBox();
        ...
        jLabel5.setText("jenis_barang_barang Barang");
        ...
        cbjenis_barang_barang
                .setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Baju", "Celana", "Jaket", "Kemeja" }));
                        ...
                        .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout
                                        ...
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                ...
                                                .addGap(44, 44, 44)
                                                .addComponent(txIDBarang, javax.swing.GroupLayout.PREFERRED_SIZE, 160,
                                        ...
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanel2Layout
                                                        ...
                                                        .addComponent(cbukuran,
                                                                ...
                                                                javax.swing.GroupLayout.PREFERRED_SIZE, 160,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(cbjenis_barang_barang,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                        ...
                        .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        ...
                                        .addComponent(txstok, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(cbjenis_barang_barang, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnEditActionPerformed
        ...
        String jenis_barang_barang = (String) cbjenis_barang_barang.getSelectedItem();
        String ukuran = (String) cbukuran.getSelectedItem();
        String harga_beli = txharga_beli.getText();
        String harga_jual = txharga_jual.getText();
        String stok = txstok.getText();

        try {
            Connection c = koneksi.getKoneksi();
            String sql = "UPDATE barang SET nama_barang = ?, jenis_barang_barang = ?, ukuran = ?, harga_beli = ?, harga_jual = ?, stok = ? WHERE id_barang = ?";
            PreparedStatement p = c.prepareStatement(sql);
            p.setString(1, nama);
            p.setString(2, jenis_barang_barang);
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnHapusActionPerformed
        ...
        int pernyataan = JOptionPane.showConfirmDialog(null, "Yakin Data Akan Dihapus", "Konfirmasi",
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnSimpanActionPerformed
        ...
        try {
            ...
            p.setString(1, id);
            p.setString(2, nama);
            p.setString(3, jenis_barang_barang);
            p.setString(4, ukuran);
            p.setString(5, harga_beli);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jTable1MouseClicked
        ...
        String jenis_barang_barang = (String) model.getValueAt(i, 2);
        String ukuran = (String) model.getValueAt(i, 3);
        String harga_beli = (String) model.getValueAt(i, 4);
        ...
        cbjenis_barang_barang.setSelectedItem(jenis_barang_barang);
        cbukuran.setSelectedItem(ukuran);
        txharga_beli.setText(harga_beli);
        txharga_jual.setText(harga_jual);
        txstok.setText(stok);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DataBarang.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
    ...
    private javax.swing.JComboBox cbjenis_barang_barang;
